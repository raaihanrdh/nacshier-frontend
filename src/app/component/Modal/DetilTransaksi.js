            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                  #{transaksi.id || transaksi.transaction_id}
                </p>
              </div>
            </div>
            <button
          ...
          <div className="space-y-6">
            ...
            <div className="text-center pb-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-center gap-2 mb-2">
                <Store theme="filled" size={24} className="text-indigo-600 dark:text-indigo-400" />
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span>
                  {transaksi.tanggal || "N/A"} {transaksi.jam ? `• ${transaksi.jam}` : ""}
                </span>
              </div>
              {transaksi.kasir && (
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 mb-3">
                <ShoppingBag theme="outline" size={18} className="text-gray-600 dark:text-gray-400" />
                <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                  Daftar Barang
                </h4>
              </div>
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {transaksi.TransDetailTransaksi && transaksi.TransDetailTransaksi.length > 0 ? (
                  transaksi.TransDetailTransaksi.map((item, index) => (
                    <div
                      key={index}
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center pt-2">
                  <div className="flex items-center gap-2">
                    <Money theme="filled" size={20} className="text-indigo-600 dark:text-indigo-400" />
                ...
                {transaksi.metodePembayaran && (
                  <div className="flex items-center justify-between pt-2 border-t border-indigo-200 dark:border-indigo-700">
